package cn.alittler.study.excel.demo.util;
...
import cn.alittler.study.excel.demo.bean.Employee;
...
public abstract class ExcelHelper {
	...
	public static void main(String[] args) {
		...
		String[] fieldNames = new String[] { "id", "name", "age", "job",
				"salery", "addtime" };
		try {
			File file1 = new File("./Excel/JXL2003.xls");
			...
			File file2 = new File("./Excel/POI2003.xls");
			...
			File file3 = new File("./Excel/POI2007.xlsx");
