...
import study.mybatis.bean.Employee;
import study.mybatis.dao.EmployeeMapper;
...
public class EmployeeTest {
	...
	public void test() throws IOException {
		...
		try {
			Employee employee = openSession.selectOne("study.mybatis.dao.EmployeeMapper.getEmpById", 2);
